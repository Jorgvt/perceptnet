...
for k, v in state.params.items():
    # print(k)
    shape_tree = jax.tree_util.tree_map(lambda x: x.size, v)
    print(shape_tree)
    n_params = sum(jax.tree_util.tree_leaves(shape_tree))
    n_params_tree[k] = n_params
    # break
print(n_params_tree)
print(sum(list(n_params_tree.values()))) 