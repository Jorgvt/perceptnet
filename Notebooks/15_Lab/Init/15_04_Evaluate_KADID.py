...
parser = argparse.ArgumentParser(description="Evaluating a model on KADID10K.",
...
# %%
# Load weights
state = orbax_checkpointer.restore(os.path.join(prev_run.dir,"model-0"), item=state)
